...
public class ModelTaxiHistory implements Serializable {
    ...
    public class Result implements Serializable
    {
        ...
        private String waiting_time_charge;

        private String waiting_time_minute;
        ...
        public String getWaiting_time_charge() {
            return waiting_time_charge;
        }

        public void setWaiting_time_charge(String waiting_time_charge) {
            this.waiting_time_charge = waiting_time_charge;
        }

        public String getWaiting_time_minute() {
            return waiting_time_minute;
        }

        public void setWaiting_time_minute(String waiting_time_minute) {
            this.waiting_time_minute = waiting_time_minute;
        }
