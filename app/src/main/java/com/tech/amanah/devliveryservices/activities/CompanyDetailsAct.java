...
public class CompanyDetailsAct extends AppCompatActivity {
    ...
    private void placeOrderApi() {
        ...
        param.put("type",MyCartActivity.type);
                ...
                try {
                    ...
                    try {
                        ...
                        if(jsonObject.getString("status").equals("1")) {
                            ...
                            Toast.makeText(CompanyDetailsAct.this,getString(R.string.order_place_success_text),Toast.LENGTH_SHORT).show();
                             startActivity(new Intent(CompanyDetailsAct.this, SelectService.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
                             finish();
                        } else {
