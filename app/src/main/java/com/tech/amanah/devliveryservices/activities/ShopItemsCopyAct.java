...
import com.tech.amanah.devliveryservices.adapters.AdapterDevShopItemsCopy;
...
public class ShopItemsCopyAct extends AppCompatActivity {

    Context mContext = ShopItemsCopyAct.this;
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")) {
                        ...
                        AdapterDevShopItemsCopy adapterDevShopItems = new AdapterDevShopItemsCopy(mContext,modelShopItems.getResult(),storeId);
